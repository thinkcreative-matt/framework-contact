...
@section('content')
	<div class="admin-container contact-container container">
		...
		{{ Form::model($form, ['route' => [ 'admin.contact.form.store' ], 'method' => 'POST', 'class' => 'needs-validation', ]) }}
			<div id="createFieldsFormRow">
				<div class="form-row" id="duplicate-row">
					...
					<div class="form-group col-md-3">
						...
						{{ Form::text('value[]', $form->value, ['class' => 'form-control ']) }}
					</div>
			...
			<div class="form-row">
				<div class="form-group col-md-12">
					{{ Form::submit('Create Contact Form', ['class' => 'btn btn-success']) }}
